...
Command: npx gltfjsx@6.5.3 newportfolioroom.glb 
*/
...
export function Room(props) {
  const { nodes, materials } = useGLTF('../public/models/newportfolioroom.glb')
  return (
    <group {...props} dispose={null}>
      <OrthographicCamera makeDefault={false} far={100} near={0.1} position={[6, 5.644, 6]} rotation={[-0.673, 0.664, 0.456]} />
      ...
      <mesh geometry={nodes.renderplane.geometry} material={materials.blue_floor} position={[0.068, -0.091, 0.006]} scale={5.111} />
      <mesh geometry={nodes.floor.geometry} material={materials.floor} position={[0.068, 0.013, 0.006]} scale={0.056} />
    </group>
  )
}

useGLTF.preload('../public/models/newportfolioroom.glb')
